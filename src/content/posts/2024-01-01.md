...
tags:
  - Knowledge
  - Technique
description: "I have multiples chapters which need to be merged into one thesis. But part of their reference.bib files are overlapped. I need to find a way to remove the duplicate when I merge the .bib files."
---
